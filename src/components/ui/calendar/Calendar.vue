  ...
  <DefineMonthTemplate #default="{ date }">
    <div class="**:data-[slot=native-select-icon]:right-1">
      <div class="relative">
        ...
        >
          <NativeSelectOption v-for="(month) of createYear({ dateObj: date })" :key="month.toString()" :value="month.month" :selected="date.month === month.month">
  ...
  <DefineYearTemplate #default="{ date }">
    <div class="**:data-[slot=native-select-icon]:right-1">
      <div class="relative">
        ...
        >
          <NativeSelectOption v-for="(year) of yearRange" :key="year.toString()" :value="year.year" :selected="date.year === year.year">
  ...
  >
    ...
    <div class="flex flex-col gap-y-4 mt-4 sm:flex-row sm:gap-x-4 sm:gap-y-0">
      <CalendarGrid v-for="month of grid" :key="month.value.toString()">
        ...
        <CalendarGridBody>
          <CalendarGridRow v-for="(weekDates, index) of month.rows" :key="`weekDate-${index}`" class="mt-2 w-full">
            <CalendarCell
